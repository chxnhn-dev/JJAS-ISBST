...
Public Class CategoryService
    ...
    Public Function GetCategoriesPage(request As PagedQueryRequest) As PagedQueryResult
        Return _repo.GetActiveCategoriesPage(request)
    End Function
    ...
    Public Function IsUsedBySizes(categoryId As Integer) As Boolean
        Return _repo.IsUsedBySizes(categoryId)
    End Function

    Public Function CanDelete(categoryId As Integer) As Boolean
        Return Not _repo.IsUsedBySizes(categoryId) AndAlso Not _repo.IsUsedByProducts(categoryId)
    End Function
