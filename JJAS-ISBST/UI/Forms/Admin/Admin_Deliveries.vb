...
Public Class Admin_Deliveries
    ...
    Private Sub LoadDeliveries(searchText As String)
        ...
        Catch ex As Exception
            LogActivity(FrmLogin.CurrentUser.UserID, FrmLogin.CurrentUser.FullName, FrmLogin.CurrentUser.Username, FrmLogin.CurrentUser.Role, $"Error loading deliveries: {ex.Message}")
    ...
    Private Sub DeleteDeliveryProductById(deliveryProductId As Integer)
        ...
        If result = DialogResult.Yes Then
            Try
                ...
                LogActivity(FrmLogin.CurrentUser.UserID, FrmLogin.CurrentUser.FullName, FrmLogin.CurrentUser.Username, FrmLogin.CurrentUser.Role, "Cancelled Deliveries.")
                MessageBox.Show("Delivery has been delete.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information)
                LoadDeliveries(String.Empty)
            Catch ex As Exception
                LogActivity(FrmLogin.CurrentUser.UserID, FrmLogin.CurrentUser.FullName, FrmLogin.CurrentUser.Username, FrmLogin.CurrentUser.Role, $"Error cancelling delivery product: {ex.Message}")
    ...
    Private Sub PostDeliveryProductById(deliveryProductId As Integer)
        ...
        Try
            ...
            LogActivity(FrmLogin.CurrentUser.UserID, FrmLogin.CurrentUser.FullName, FrmLogin.CurrentUser.Username, FrmLogin.CurrentUser.Role, "Posted delivery with cost merge.")
            ...
            LoadDeliveries(String.Empty)
        Catch ex As Exception
            LogActivity(FrmLogin.CurrentUser.UserID, FrmLogin.CurrentUser.FullName, FrmLogin.CurrentUser.Username, FrmLogin.CurrentUser.Role, $"Error posting delivery product: {ex.Message}")
