...
Public Class Admin_transaction
    ...
    Private Sub displayData(searchText As String)
        ...
        DGVTransacopn.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill
            ApplyStandardGridLayout(DGVTransacopn)
        ...
        Try
            ...
            Using printDlg As New PrintDialog()
                ...
                If printDlg.ShowDialog() = DialogResult.OK Then
                    ...
                    LogActivity(FrmLogin.CurrentUser.UserID, FrmLogin.CurrentUser.FullName, FrmLogin.CurrentUser.Username, FrmLogin.CurrentUser.Role, "Printed Transaction.")
