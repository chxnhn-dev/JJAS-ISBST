...
Public Class FrmInventory
    ...
    Private Sub displayData(searchText As String)
        ...
        ORDER BY d.DateCreated DESC;"
            ...
            If DGVtable.Columns.Contains("StockLevelStatus") Then
                DGVtable.Columns("StockLevelStatus").DisplayIndex = 0
                DGVtable.Columns("StockLevelStatus").HeaderText = "Stock Status"
            End If

            ' --- Image column settings ---
            If DGVtable.Columns.Contains("ProductImage") Then
                DGVtable.Columns("ProductImage").DisplayIndex = 1
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        dtPosted = CType(DGVtable.DataSource, DataTable)
        currentRow = 0
