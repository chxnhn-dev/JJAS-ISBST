...
Public Class FrmPOS
    ...
    Private Sub ConfigureCartGridColumns()
        ...
        If DGVtable.Columns.Contains("ProductImage") Then
            Dim imgCol As DataGridViewImageColumn = TryCast(DGVtable.Columns("ProductImage"), DataGridViewImageColumn)
        ...
        If DGVtable.Columns.Contains("BarcodeNumber") Then
            DGVtable.Columns("BarcodeNumber").HeaderText = "Barcode"
        End If

        If DGVtable.Columns.Contains("ProductName") Then
            DGVtable.Columns("ProductName").HeaderText = "Product"
        End If

        If DGVtable.Columns.Contains("Quantity") Then
            DGVtable.Columns("Quantity").HeaderText = "Qty"
            DGVtable.Columns("Quantity").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter
        End If

        If DGVtable.Columns.Contains("SellingPrice") Then
            DGVtable.Columns("SellingPrice").HeaderText = "Price"
            ...
            DGVtable.Columns("SellingPrice").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        End If
    End Sub
    ...
    Private Sub DGVCart_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DGVtable.CellContentClick
        ...
        Dim clickedColName As String = DGVtable.Columns(e.ColumnIndex).Name
