...
Public Class FrmTransactions
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        Try
            ...
            If TypeOf DGVtable.DataSource Is DataTable Then
                dtSales = CType(DGVtable.DataSource, DataTable)
            ElseIf TypeOf DGVtable.DataSource Is BindingSource Then
                Dim bs = CType(DGVtable.DataSource, BindingSource)
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("Printed by: " & FrmLogin.CurrentUser.FullName, fontSmall, Brushes.Black, leftMargin, y)
        y += 20
    ...
    Private Sub btnFileM_Click(sender As Object, e As EventArgs)  Handles btnFileMaintenance.Click
