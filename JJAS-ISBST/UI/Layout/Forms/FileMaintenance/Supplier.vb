Namespace FileMaintenance
    Public Class Supplier
        ...
        Private _service As SupplierService
        ...
        Protected Overrides Sub LoadTableData(searchText As String)
            ...
            Dim page As PagedQueryResult = LoadPagedData(searchText, Function(request) _service.GetSuppliersPage(request))
        ...
        Private Sub DeleteById(supplierId As Integer)
            ...
            _service.DeactivateSupplier(supplierId)
