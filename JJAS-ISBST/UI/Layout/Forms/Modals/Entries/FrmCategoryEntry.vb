...
Public Class FrmCategoryEntry
    ...
    Private Property EntryType As SharedEntryType = SharedEntryType.Category
    ...
    Private Sub FrmCategoryEntry_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
