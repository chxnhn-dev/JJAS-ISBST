...
Public Class FrmColorEntry
    ...
    Private Property EntryType As SharedEntryType = SharedEntryType.Color
    ...
    Private Sub FrmColorEntry_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
